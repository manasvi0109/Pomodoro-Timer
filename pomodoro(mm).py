...
# Create Canvas
canvas = Canvas(width=200, height=224, bg=BLUE, highlightthickness=0)  # highlightthickness removes the canvas border
...
# Add Title Label
title_label = Label()
title_label.config(text="Timer", font=(FONT_NAME, 50), fg=GREEN, bg=BLUE)
...
check_marks_label = Label(font=(FONT_NAME, 25), bg=BLUE, fg=GREEN)
